...
function gotoSurvey(){
  ...
  if (document.getElementById("checkbox_Identity").checked &&
  document.getElementById("checkbox_Contacts").checked &&
  document.getElementById("checkbox_Location").checked &&
  document.getElementById("checkbox_Phone").checked &&
  document.getElementById("checkbox_Photos").checked &&
  document.getElementById("checkbox_Storage").checked &&
  document.getElementById("checkbox_Camera").checked &&
  document.getElementById("checkbox_Microphone").checked &&
  document.getElementById("checkbox_WiFi").checked &&
  document.getElementById("checkbox_DeviceID").checked &&
  document.getElementById("checkbox_Others").checked) {
...
function nextChannel(){
  ...
  var currentSequence = channelOrder.indexOf('permission');
...
function submit(){
  ...
  localStorage.setItem('PM-C1', C1_answer);
  localStorage.setItem('PM-C2', C2_answer);

  localStorage.setItem('PM-C3', JSON.stringify(C3_answer));
  if (C3_answer.includes("Others")){
     localStorage.setItem('PM-C3_other', C3_others);
  }
  localStorage.setItem('PM-C4', JSON.stringify(C4_answer));
  if (C4_answer.includes("Others")){
     localStorage.setItem('PM-C4_other', C4_others);
  }
  localStorage.setItem('PM-C5', JSON.stringify(C5_answer));
  if (C5_answer.includes("Others")){
     localStorage.setItem('PM-C5_other', C5_others);
  }
  localStorage.setItem('PM-C6', JSON.stringify(C6_answer));
  if (C6_answer.includes("Others")){
     localStorage.setItem('PM-C6_other', C6_others);
  }
  localStorage.setItem('PM-C7', JSON.stringify(C7_answer));
  if (C7_answer.includes("Others")){
     localStorage.setItem('PM-C7_other', C7_others);
  }



  localStorage.setItem('PM-C8', C8_answer);
  localStorage.setItem('PM-C9', C9_answer);
  localStorage.setItem('PM-C10', C10_answer);
  localStorage.setItem('PM-C11', C11_answer);
  localStorage.setItem('PM-C12', C12_answer);
  localStorage.setItem('PM-C12-open-question', C12_answer_open);
  localStorage.setItem('PM-C13', C13_answer);
  localStorage.setItem('PM-C13-open-question', C13_answer_open);
