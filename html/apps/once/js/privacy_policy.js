...
function gotoSurvey(){
  ...
  if (document.getElementById("section1").checked && 
      ...
      document.getElementById("section6").checked &&
      document.getElementById("section7").checked &&
      document.getElementById("section8").checked &&
      document.getElementById("section9").checked) {
